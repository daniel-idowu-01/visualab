      ...
      <div className="max-w-4xl w-full space-y-10 text-center">
        <div className="space-y-6">
          ...
          <p className="text-xl text-neutral-700 max-w-2xl mx-auto">
            Generate stunning product ads, packshots, and lifestyle shots with
            Bria AI's powerful image generation and manipulation.
          </p>
          <div>
            <Link href="/editor">
              <Button
          ...
          <Card className="bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 border border-neutral-200">
            ...
            <CardContent className="pt-4">
              <p className="text-neutral-700 mb-4">
                Explore a curated collection of templates and inspiring examples
